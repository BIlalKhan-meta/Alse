    ...
    if (Platform.OS === 'android') {
      const granted = await PermissionsAndroid.request(
        PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
        {
          ...
          message: 'This app needs to access your location to show your current address',
    ...
    try {
      ...
      if (data && data.display_name) {
        ...
        if (address.city || address.town || address.village) {
          formattedAddress += formattedAddress ? `, ${address.city || address.town || address.village}` : (address.city || address.town || address.village);
        }
