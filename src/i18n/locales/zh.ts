export default {
  ...
  feed: {
    ...
    empty: {
      all: '暂无内容。',
      allHint: '你关注的人发布的帖子会显示在这里。',
      following: '关注更多用户以发现内容。',
      followingHint: '使用搜索查找要关注的人。',
      videos: '暂无视频帖子。',
      images: '暂无图片帖子。',
      stories: '动态中没有故事帖子。',
      storiesHint: '请查看上方动态栏中关注用户的更新。',
    },
  },
  public: '公开',
  private: '私密',
  ...
  editDraftStale: '此帖子可能已被删除。是否删除此草稿？',
  draftDeleted: '草稿已删除',
  draftNewPost: '新帖子',
  draftEditPost: '编辑帖子 #{{id}}',
  draftNoText: '暂无文字',
  savingDraft: '正在保存草稿...',
