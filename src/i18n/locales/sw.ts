export default {
  ...
  feed: {
    ...
    empty: {
      all: 'Hakuna maudhui bado.',
      allHint: 'Machapisho kutoka kwa watu unaowafuata yataonekana hapa.',
      following: 'Fuata watumiaji zaidi kugundua maudhui.',
      followingHint: 'Tafuta watu wa kufuata kwa kutumia utafutaji.',
      videos: 'Hakuna machapisho ya video.',
      images: 'Hakuna machapisho ya picha.',
      stories: 'Hakuna hadithi katika mlisho wako.',
      storiesHint: 'Angalia safu ya hadithi hapo juu kwa sasisho.',
    },
  },
  public: 'Wazi',
  private: 'Binafsi',
