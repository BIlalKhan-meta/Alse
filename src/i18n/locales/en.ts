export default {
  ...
  musicRequiresOneImage: 'Music is available for single-image posts only',
  musicNotWithVideo: 'Remove the video before adding music',
  composingMusicVideo: 'Adding music to your photo...',
  ...
  musicComposeFailed: 'Could not add music to your photo. Please try again.',
