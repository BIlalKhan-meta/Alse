export default {
  ...
  feed: {
    ...
    empty: {
      all: 'Aún no hay contenido disponible.',
      allHint: 'Las publicaciones de las personas que sigues aparecerán aquí.',
      following: 'Sigue a más usuarios para descubrir contenido.',
      followingHint: 'Encuentra personas para seguir usando la búsqueda.',
      videos: 'No hay publicaciones de video disponibles.',
      images: 'No hay publicaciones de imagen disponibles.',
      stories: 'No hay historias en tu feed.',
      storiesHint: 'Mira la fila de historias arriba para ver actualizaciones.',
    },
  },
  public: 'Público',
  private: 'Privado',
  ...
  deleteDraftConfirm: '¿Seguro que quieres eliminar este borrador?',
  noDrafts: 'Aún no hay borradores',
  draftLoadFailed: 'No se pudo cargar el borrador',
  editDraftStale: 'Esta publicación puede haber sido eliminada. ¿Eliminar este borrador?',
  draftDeleted: 'Borrador eliminado',
  draftNewPost: 'Nueva publicación',
  draftEditPost: 'Editar publicación #{{id}}',
  draftNoText: 'Sin texto aún',
