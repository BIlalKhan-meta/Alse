...
const Summary: React.FC<SummaryProps> = ({ subTotal, deliveryCharges, discount, grandTotal, style, titleStyle }) => (
    <Card style={[styles.summaryContainer, style]}>
        <InterBoldSmall style={[styles.summary, titleStyle]}>Summary</InterBoldSmall>
        ...
        <View style={styles.summaryTxtContainer}>
            ...
            <InterRegular style={styles.summaryPrice}>${deliveryCharges}</InterRegular>
        </View>
        <View style={styles.summaryTxtContainer}>
        ...
        <View style={styles.summaryTxtContainer}>
            ...
            <InterRegular style={styles.summaryPrice}>${grandTotal}</InterRegular>
        </View>
