...
const styles = StyleSheet.create({
    ...
    title: { color: colors.darkGray, marginHorizontal: vw * 5, marginVertical: vh * 1.5, },
    styledline: { backgroundColor: colors.lightSilver, borderColor: colors.lightSilver, borderWidth: vw * 0.1, width: vw * 85, alignSelf: 'center' },
    unreadContainer: {
        flexDirection: "row",
